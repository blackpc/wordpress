...
class PostRatings{
  ...
  */
  public function CreateMenu(){
	...
	add_menu_page(__('Post Ratings', self::ID), __('Post Ratings', self::ID), 'manage_options', self::ID, array($this, 'SettingsPage'));
	//add_submenu_page( 'Post Ratings', $themename, __( 'Post Ratings', self::ID ), 'manage_options', 'options-framework', 'optionsframework_page' );
  }
...
-->
  ...
  */
  public function assets(){
    ...
    wp_enqueue_script(self::ID, get_template_directory_uri() .'/js/post-ratings.js', array('jquery'), self::VERSION, true);
    ...
    $style = is_readable(get_stylesheet_directory().'/css/post-ratings.css') ? get_stylesheet_directory_uri().'/css/post-ratings.css' : plugins_url('post-ratings.css', __FILE__);
