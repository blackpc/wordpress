...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		...
		$icon 		= get_template_directory_uri().'/admin/images/minimal-theme-icon.png';

	    if( function_exists( 'add_object_page' ) ) {
	      	add_object_page ( 'Theme Options', $themename, 'manage_options', 'options-framework', 'optionsframework_page', $icon );
	    } else {
	      	add_menu_page ( 'Theme Options', $themename, 'manage_options', 'options-framework', 'optionsframework_page', $icon );
	    }
	    $of_page = add_submenu_page( 'options-framework', $themename, __( 'Magz Options', 'nesia' ), 'manage_options', 'options-framework', 'optionsframework_page' ); // Default
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( 'toplevel_page_options-framework' != $hook )
        return;
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'options-framework',
			'id' => 'of_theme_options',
			'title' => __( 'Magazine', 'options_framework_theme' ),
